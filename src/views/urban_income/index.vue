<template>
  <d2-container>
    ...
    <el-row v-show="showChart" style="margin-top: 20px">
      <el-col :span="20">
        <div id="chart6" ref="chart6" style="width: 100%;height: 600px" />
      </el-col>
      <el-col :span="4">
        <!--        右侧功能栏-->
...
export default {
  ...
  mounted () {
    this.showChart = false
    this.chart = echarts.init(document.getElementById('chart6'))
  },
  created () {
    this.initData()
  },
  ...
  methods: {
    async initData () {
      ...
      params.append('tablename', 'income_urban_rural_engelcoefficient_info')
